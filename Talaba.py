class Talaba:
    company = ('https://erp.student.najottalim.uz/')
    ...
    def school(self, school_class):
        self.school = self.age - 7
        return self.school
    ...
    def control_password(self):
        ...
        for item in self.password:
            ...
            if item in belgilar:
                E = True
        if A and B and C and D and E and len(self.password) >= 8:
    ...
    def control_email(self):
        if '@gmail.com' in self.email or 'email.ru' in self.email:
